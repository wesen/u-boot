...
#define CONFIG_BOOTCOMMAND	"cp.b 0xD0030000 0x22000000 0x2B0000; bootm"
#define CONFIG_BOOTARGS		"root=/dev/ram rw console=ttyS0,115200,mem=32M"
#endif

#define CONFIG_ENV_IS_IN_DATAFLASH	1
#define CFG_MONITOR_BASE	(CFG_DATAFLASH_LOGIC_ADDR_CS1 + 0x3000)
#define CONFIG_ENV_OFFSET		0x2000
#define CONFIG_ENV_ADDR		(CFG_DATAFLASH_LOGIC_ADDR_CS1 + CONFIG_ENV_OFFSET)
#define CONFIG_ENV_SIZE		0x1000
#define CONFIG_BOOTCOMMAND	"cp.b 0xD0040000 0x22000000 0x2B0000; bootm"
#define CONFIG_BOOTARGS		"root=/dev/ram rw console=ttyS0,115200,mem=32M"
...
#define CONFIG_BOOTSTEND		0xD0001FFF
#define CONFIG_BOOTCFSTART      0xD0002000
#define CONFIG_BOOTCFEND		0xD0002FFF
#define CONFIG_BOOTLDSTART		0xD0003000
#define CONFIG_BOOTLDEND		0xD003FFFF
#define CONFIG_OSSTART          0xD0040000
#define CONFIG_OSEND			0xD027FFFF
#define CONFIG_FSSTART			0xD0280000
#define CONFIG_FSEND			0xD06FFFFF
#define CONFIG_CONFSTART		0xD0700000
